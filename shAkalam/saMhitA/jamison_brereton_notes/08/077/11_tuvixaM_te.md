...
+++
sūmáya- is generally analyzed as having the adverbial prefix su- ‘good’, hence ‘aus gutem Stoff’ (Geldner). However, AiG II.2.770 reports a suggestion of Thieme's (apparently only reported in AiG, not publ.) that it's ‘aus Eber(-zahn) verfertigt’, with an unextended root noun sū- ‘(wild) pig, boar’, which is the basis of sūkará- ‘boar’ (already RV VII.55.4) and which has numerous IE cognates.
