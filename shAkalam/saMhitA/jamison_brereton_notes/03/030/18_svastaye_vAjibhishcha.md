...
+++
It is difficult to know how to construe the first pāda of this vs. I take it as a nominal main clause expressing the purpose of the subordinate clause in b. Geldner (/WG) as a parallel subordinate clause with pāda b, for which a verb (ausziehst ‘set out for’) must be supplied -- all dependent on pāda c. Renou as part of a single subord. cl.
