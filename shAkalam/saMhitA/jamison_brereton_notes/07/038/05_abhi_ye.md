...
The VP rātím √sap seems almost to be a gloss of the root-noun compd. rātiṣā́c- and might help us determine the function of this enigmatic group of divinities or semi-divinities. The use of a transitive VP as apparent gloss makes it unlikely (at least to me) that -sā́c- has a passive / intransitive sense in the cmpd (Scar’s ‘von Gaben begleitet’ [593, Geldner sim.], Renou’s ‘qui ont le don pour attribut’). Gr’s transitive ‘Gabe gewährend, Spende betreibend’ is closer to the mark, though muddling the sense of the root √sac.
