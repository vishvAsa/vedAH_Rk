...
But these passages lack the preverb: although Gr lists VI.5.3 with ví as preverb, and Geldner apparently follows him, ví in that passage should be construed otherwise, not as a preverb with inoṣi; see comm. ad loc. In my opinion a more telling parallel is found in VI.10.7, also in this Agni cycle, with the ví: ví dvéṣāṃsīnuhí “dispel hatreds.” Renou also considers the expression to be negative, on the basis of the same parallel, and tr.
...
Geldner and Renou take áśna- as a PN, but I see no reason not to take it, with Gr, as a straightforward derivative of √aś ‘eat’. Mayr splits the difference in his PN book, listing it as a PN but noting its likely original identity with the adj. áśna- ‘hungry’.
