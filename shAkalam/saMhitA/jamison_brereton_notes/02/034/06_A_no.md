...
+++
In pāda a the grammatical problem is svàr (to be read as a monosyllable, [almost] uniquely in the RV). Gr identifies it as an acc., Macd (followed implicitly by Doniger and Maurer) as an endingless loc., sim. Renou However, the phraseology, esp.
...
The “raw” (āmá-) fortifications are convincingly explained by Geldner as built from unfired brick. They need not (and in my opinion should not) be further interpreted as cloud citadels (so Macd, fld. by Maurer and, in part, Doniger).
