...
9, 11 above), and provides an easy transition to the invocation of Agni in the next vs. The subj. of dhārayanta in b I take as the gods in c (with Oldenberg, SBE, Hoffmann, WG), rather than taking c as a separate nominal cl. (Geldner, Renou). Note the chiastic morphological figure in c, allowing alliteration between the nom./loc. pairs: víśve víśvāsu dúryāsu devā́(ḥ).
