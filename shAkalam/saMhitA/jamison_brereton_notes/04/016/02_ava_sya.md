...
The subj. of pāda b must be different from that in a; I follow Geldner (/WG) in taking it as the pressing stone. The idiom ví √pā ‘extract/separate by drinking’ favors this identification; see comm. ad VII.22.4, which passage also contains a form of √arc as here as well as an overt occurrence of the ‘stone’ (ádri-).

Unlike Geldner (/WG) I do not take pāda c as the main clause with b, nor do I think they have the same subject. Rather with Schmidt (B+I, 48-49) I tentatively take Indra as subj. in c (though not, with Schmidt, a and b as well). The Vala myth is quietly introduced in this second half-vs., with Indra’s creation of the poets and then their singing into existence the ritual patterns. With Geldner (etc.) it is likely that the seven bards are the Aṅgirases.
