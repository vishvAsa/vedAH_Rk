...
As generally noted by tr. (Geldner, Renou, also Scarlatta [72]), pāda d involves a play on the names of the Anuṣṭubh and Virāj meters. The publ. tr. fails to register the pun on virā́jam, well captured by Scarlatta “Soma herrscht nach Art eines Grosskönigs.” I would now substitute a fuller (if more awk.) tr.: “Soma, as rhythm [/ the Anuṣṭubh meter], rules as wide-ruling one [/regulates the Virāj (meter) according to rule].” This tr.
