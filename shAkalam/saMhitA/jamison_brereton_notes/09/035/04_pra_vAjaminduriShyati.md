...
Geldner assigns vidānáḥ to √vid ‘know’ (“der sich auf die Vorschriften, auf die Waffen versteht”), while Renou (though see his n.) and the publ. tr. take it to √vid ‘find’ (as a root aor.

part.). I now think either (or both) is/are possible, but that in either case vratā́and ā́yudhā are not separate objects as Geldner/Renou take them, but an equational phrase (as in the publ. tr.).
