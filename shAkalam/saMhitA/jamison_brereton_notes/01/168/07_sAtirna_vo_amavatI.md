...
The curiously formed hapax fem. pípiṣvatī is best explained, with Oldenberg, as based on the perfect part. to √pi ‘swell’, pīpivā́ṃs-, fem. pipyúṣī, crossed with a - vant-stem to match ámavatī svàrvatī in pāda a. Despite the tricky morphological manipulation required, I prefer this to the easier derivation from √piṣ ‘crush’, assumed by Geldner’s ‘zerschmetternd’ (with ?), fld. by Witzel Gotō., and Renou’s ‘pulvérisant’. Gr (flg. BR) takes it as built to a desiderative to √pi, but there are no desiderative forms to this root, whereas the pf. part. is quite well attested, esp. in the fem.
