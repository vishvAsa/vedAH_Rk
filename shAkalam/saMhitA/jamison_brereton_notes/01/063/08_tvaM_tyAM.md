...
I take tmánam as functioning as a reflexive pronoun (“extend yourself”), while most tr. take it as a noun (Geldner ‘Lebensgeist’, WG ‘Lebenshauch’). This is the only acc. to the truncated stem tmán-, and so its usage is hard to determine. The oblique cases (dominated by inst. tmánā) generally refer to the self (‘by yourself, for ourselves’, etc.), without a full-blown nominal sense, which accounts for my tr.
