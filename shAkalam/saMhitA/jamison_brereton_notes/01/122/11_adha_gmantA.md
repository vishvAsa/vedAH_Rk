...
However, in the dānastuti context names are more likely, though they can be speaking names. That -jū- echoes -jūta- in 10a and -ravá- echoes ruvaṇyú- in 5a (assuming an analysis ni-ravá- with Oldenberg, rather than nir-avá- with Gr) is presumably no accident: puns on personal names are a standard RVic poetic device.
