...
There is difference of opinion on how the simile works in d. Flg. Oldenberg, Renou, and the line of least resistance, I resupply the verb rákṣa from c, maintaining Indra as subj., compared to a lion. Geldner (/WG) take the subj. as Agni and then must supply another verb, not available in the context. This seems like too much machinery to me, since the pāda is readily interpretable on the syntactic pattern in c.
