...
I take juhurāṇá- to √hvṛ / hru ‘go crookedly, go astray’ (with Geldner and Renou, as well as Gr), rather than with √hṛ ‘be angry’ with Insler (JAOS 88, 1968), apparently followed by Witzel Gotō (“den zürnenden Frevel”). The contrast between the easy path in pāda a and the énas- that goes crookedly/astray in c supports this ascription, as does abhihrút- in 6d. Agastya uses the same participle in I.173.11, where its affinity to √hvṛ rather than √hṛ is even clearer.
