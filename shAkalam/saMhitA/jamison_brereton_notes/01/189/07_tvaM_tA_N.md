...
+++
The ví with vidvā́n picks up the ví that both opens and closes the preceding verse (ví … yaṃsat / viṣpáṭ), linking this verse to the apparently different topic that precedes it. This provides a clue for the referent of tā́n … ubháyān “those both.” Geldner (/WG) take the both to refer to the two time periods mentioned in this verse, prapitvé and abhipitvé, but, on the basis of the larger context, with Oldenberg (SBE) and Renou I think it refers to good and bad men, or more narrowly to sacificers and non-sacrificers.
...
In b Geldner (/WG) supply ‘nourishment’ (die Nahrung) as object of véṣi with mánuṣaḥ as gen. sg., but this seems unnecessary.
