...
1 [F1] . After one year the Cūḍākarman (i.e. the tonsure of the child's head);

[F1]:  28, 1. Cūḷākarman literally means, the preparing of the lock or the locks (left when the rest of the hair is shaven).
...
[F2]:  The parallel texts show that instead of Bṛhaspatir we have to read Bṛhaspater, instead of adya, asya. So the correct translation would be, '. . . with what Dhātar has shaven Bṛhaspati's and Indra's head, with that do ye Brāhmaṇas shave this head of this (child).'
...
24 [F3] . To the barber the vessels of grain. To the barber the vessels of grain.
