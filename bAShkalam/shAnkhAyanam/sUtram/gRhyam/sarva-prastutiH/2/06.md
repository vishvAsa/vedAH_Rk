...
1 [F1] . 'Waters are ye by name; happy ones are ye by name; sappy ones are ye by name; undecaying ones are ye by name; fearless ones are ye by name; immortal ones are ye by name. Of you, being such, may I partake; receive me into your favour' - with these words (the teacher) makes the student sip water three times,
...
2 [F2] . And hands over to him the staff with the five verses, 'Blessing may give us' (Rig-veda V, 51, 11-15).

[F2]:  These five verses have already occurred above at I, 15, 12.
...
3 [F3] . An optional gift is the fee for the sacrifice.
...
4 [F4] . After (the teacher) has led him round the fire, turning his right side towards it, (the student) goes through the village to beg food.

[F4]:  4 seq. On the student's begging of alms compare the more detailed rules in Pāraskara II, 5; Āpastamba I, 3, &c.
...
7 [F5] . Having announced the alms to his teacher, he may eat (the food himself) with the master's permission.

[F5]:  Comp. the passages quoted by Professor Bühler on Āpastamba I, 3, 31 (S.B.E., vol. ii, p. 22).
