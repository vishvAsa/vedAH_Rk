...
```
git clone --single-branch --depth 1 --branch master https://github.com/XYZ/vedAH_Rk.git vedAH-master
cd vedAH-master
...
git clone --single-branch --depth 1 --branch content https://github.com/XYZ/vedAH_Rk.git vedAH-content
cd vedAH-content
git remote add upstream https://github.com/vishvAsa/vedAH_Rk.git
git pull upstream content
cd ..

git clone --single-branch --depth 1 --branch static_files https://github.com/XYZ/vedAH_Rk.git vedAH-static
cd vedAH-static
git remote add upstream https://github.com/vishvAsa/vedAH_Rk.git
