...
- If https://github.com/XYZ/vedAH_Rk exists beforehand, please delete it by going to settings using your browser.
- Go to https://github.com/vishvAsa/vedAH_Rk and fork (there should be a Fork button in the top-right). Thence, you will
  get https://github.com/XYZ/vedAH_Rk .
...
```
git clone --single-branch --depth 1 --branch master https://github.com/XYZ/vedAH_Rk.git vedAH_Rk-master
cd vedAH_Rk-master
git remote add upstream https://github.com/vishvAsa/vedAH_Rk.git
git submodule update --init  themes/sanskrit-documentation-theme-hugo
cd ..

git clone --single-branch --depth 1 --branch content https://github.com/XYZ/vedAH_Rk.git vedAH_Rk-content
cd vedAH_Rk-content
git remote add upstream https://github.com/vishvAsa/vedAH_Rk.git
git pull upstream content
cd ..

git clone --single-branch --depth 1 --branch static_files https://github.com/XYZ/vedAH_Rk.git vedAH_Rk-static
cd vedAH_Rk-static
git remote add upstream https://github.com/vishvAsa/vedAH_Rk.git
...
- If you're chaning files in `vedAH_Rk-content` :
  ...
  - Then go to https://github.com/XYZ/vedAH_Rk/tree/content and send a pull request .
- If you're changing files in `vedAH_Rk-static` :
  - Make sure that you're working on the latest files by running: `git pull upstream static_files` .
  - Then, commit and push your changes (using atom editor, or github desktop or commands
    like `git commit -am "Some message"` and `git push`).
  - Then go to https://github.com/XYZ/vedAH_Rk/tree/static_files and send a pull request .
