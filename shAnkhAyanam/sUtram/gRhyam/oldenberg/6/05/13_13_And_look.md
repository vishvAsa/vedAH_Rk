+++
title = "13 13 And look"

+++
13. And look at the sun with (the words), 'From here I take out the brightness (?).'

Khaṇḍa 5, 1 [^2] . 'That (I place) within myself' - with (these words they turn their thoughts to the universal) Self that is placed (within themselves?)three times repeated (?).
